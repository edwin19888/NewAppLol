        ...
        buttonSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(summonername.length() > 0){
                    ...
                    Toast.makeText(SearchActivity.this,"Ingrese Usuario",Toast.LENGTH_SHORT).show();
                }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.nav_search:
                Intent intSea = new Intent(SearchActivity.this,SearchActivity.class);
                startActivity(intSea);
                break;
            case R.id.nav_patch:
                Intent intPat = new Intent(SearchActivity.this,PatchActivity.class);
